...
/// USB report descriptor. HID core answers GET_REPORT only for ids declared here: `0x01`
/// in, `0x05` out, `0x02`/`0x12`/`0xa3` feature. Bind is VID/PID, not this blob. The
/// Windows driver carries a byte copy (`motion_contract` pins it).
#[rustfmt::skip]
pub const DS4_RDESC: &[u8] = &[
