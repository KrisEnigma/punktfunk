...
distro with no punktfunk repo can still run the client. `--channel stable|canary`, `--mgmt-port`,
...
`PUNKTFUNK_INSTALL_OMARCHY_THEME`, `PUNKTFUNK_INSTALL_MGMT_PORT`, `PUNKTFUNK_INSTALL_DRY_RUN`).
