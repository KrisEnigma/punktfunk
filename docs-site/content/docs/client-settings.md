...
a pixel or two of bar beats blurring the whole picture. Linux, Windows, Android and the console
home. On Android before 10, Crop to fill shows the picture squeezed instead: that path has no way
