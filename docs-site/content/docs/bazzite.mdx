...
are. The update restarts the console and host for you. Updating from 0.36 or older, restart them
yourself once: `systemctl --user restart punktfunk-web punktfunk-host`.
