...
export type SessionRow = { readonly "access_level"?: string | null, readonly "client": string, readonly "client_name"?: string | null, readonly "hdr": boolean, readonly "id"?: number, readonly "join": boolean, readonly "link"?: null | { readonly "abr_backoffs": number, readonly "abr_max_kbps": number, readonly "abr_min_kbps": number, readonly "anchor_p": number, readonly "egress_kbps": number, readonly "fec_max_pct": number, readonly "fec_min_pct": number, readonly "gaps": number, readonly "idr": number, readonly "intra_refresh": number, readonly "keyframe_req": number, readonly "loss_max_ppm": number, readonly "loss_mean_ppm": number, readonly "loss_windows": number, readonly "retargets": number, readonly "rfi": number, readonly "rfi_declined": number, readonly "secs": number, readonly "session_id": number, readonly "unrecovered": number, readonly "windows": number }, readonly "mode": string, readonly "muted": boolean, readonly "pads": ReadonlyArray<number>, readonly "plane": Plane, readonly "preferred_pad_slot"?: number, readonly "uptime_s": number }
