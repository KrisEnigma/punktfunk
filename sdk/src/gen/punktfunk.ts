...
export type OperatorGameEntry = { readonly "description"?: string | null, readonly "developer"?: string | null, readonly "genres"?: ReadonlyArray<string>, readonly "platform"?: string | null, readonly "players"?: never, readonly "publisher"?: string | null, readonly "region"?: string | null, readonly "release_year"?: never, readonly "tags"?: ReadonlyArray<string>, readonly "art": Artwork, readonly "icon"?: string | null, readonly "id": string, readonly "launch"?: null | LaunchSpec, readonly "provider"?: string | null, readonly "role"?: GameRole, readonly "stats"?: null | { readonly "last_played_unix_ms": number, readonly "last_run_ms": number, readonly "launch_count": number, readonly "play_time_ms": number }, readonly "store": string, readonly "title": string, readonly "hidden"?: boolean }
