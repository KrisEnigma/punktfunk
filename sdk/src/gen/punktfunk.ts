...
export type SettingKind = "bool" | "int" | "enum" | "text" | "list"
export const SettingKind = Schema.Literals(["bool", "int", "enum", "text", "list"])
