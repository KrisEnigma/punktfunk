...
export type SessionRef = { readonly "client": string, readonly "fingerprint"?: string | null, readonly "hdr": boolean, readonly "id": number, readonly "mode": string }
...
export type GameRefPayload = { readonly "app"?: string | null, readonly "client": string, readonly "fingerprint"?: string | null, readonly "plane": Plane, readonly "store"?: string | null, readonly "title": string }
export const GameRefPayload = Schema.Struct({ "app": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Store-qualified id (`steam:570`). Absent for an operator-typed GameStream `apps.json` command." })), "client": Schema.String, "fingerprint": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Stable id of the device that launched it; the filter handle a name cannot be." })), "plane": Plane, "store": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "`steam`, `heroic`, `custom`, … when known." })), "title": Schema.String })
...
export type StreamRef = { readonly "app"?: string | null, readonly "client": string, readonly "fingerprint"?: string | null, readonly "hdr": boolean, readonly "mode": string, readonly "plane": Plane }
export const StreamRef = Schema.Struct({ "app": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Store-qualified id on the native plane, app title on GameStream." })), "client": Schema.String, "fingerprint": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "The device's stable id — what a hook filter should key on, since a display name is\nneither unique nor fixed. Absent for an anonymous client." })), "hdr": Schema.Boolean, "mode": Schema.String.annotate({ "description": "`WxH@Hz`." }), "plane": Plane }).annotate({ "description": "Live video stream (what the stream marker file reflects)." })
