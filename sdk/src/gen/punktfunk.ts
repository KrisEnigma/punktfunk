...
export type DisplaySettingsState = { readonly "client_enforced": ReadonlyArray<string>, readonly "clients": { readonly [x: string]: ClientOverlay }, readonly "configured": boolean, readonly "custom_presets": ReadonlyArray<CustomPreset>, readonly "effective": EffectivePolicy, readonly "enforced": ReadonlyArray<string>, readonly "presets": ReadonlyArray<PresetInfo>, readonly "settings": { readonly "capture_monitor"?: string | null, readonly "clients"?: { readonly [x: string]: ClientOverlay }, readonly "ddc_power_off"?: boolean, readonly "edid_lock"?: boolean, readonly "game_session"?: "auto" | "dedicated", readonly "identity"?: Identity, readonly "keep_alive"?: KeepAlive, readonly "keep_monitors"?: ReadonlyArray<string>, readonly "layout"?: Layout, readonly "max_displays"?: number, readonly "mode_conflict"?: ModeConflict, readonly "pnp_disable_monitors"?: boolean, readonly "preset"?: Preset, readonly "topology"?: Topology, readonly "version"?: number } }
