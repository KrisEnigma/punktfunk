...
/// root file covers the whole workspace, so it would attribute crates this app never bundles
/// — a false statement to the user's face, three lines under a card saying otherwise.
