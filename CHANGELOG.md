...
904 commits since v0.34.0. Wire stays 2. C ABI stays 28. **Driver protocol floor 8.**
Deep dive: `git log v0.34.0..v0.35.0`

### Versions

| | v0.34.0 | Unreleased | Notes |
|---|---|---|---|
...
| `api/openapi.json` | 0.34.0 | **0.34.0** | Additive: `GET /api/v1/webtransport`, `POST /api/v1/auth/device/challenge`, `POST /api/v1/auth/device/token`. `info.version` still 0.34.0 |
